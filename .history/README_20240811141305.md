...
此项目采用MIT许可证 - 有关详细信息，请参阅[LICENSE](LICENSE)文件。同时，本项目的语音识别部分使用了科大讯飞的星火Lite模型的API，科大讯飞公司授权非商业性使用本产品，但是如果要进行商业性使用（包括但不限于：销售、复制、散发、预装、捆绑或用于其他商业活动）时，必须事先获得科大讯飞公司的书面授权和许可。具体请参见[讯飞开发平台服务协议](https://www.xfyun.cn/doc/policy/agreement.html)，如未经科大讯飞公司许可将本项目用于商业性活动导致纠纷，本人不承担任何责任。